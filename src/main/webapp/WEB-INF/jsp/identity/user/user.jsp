...
<!-- 						</td> -->
						...
						<td>	
						<button type="submit" id="selectUser" class="btn btn-default"><span class="glyphicon glyphicon-search"></span>&nbsp;查询</button>
				...
				<table class="table table-dark">
					<thead>
						<tr style="font-size: 12px;" align="center">
							<th scope="col" style="text-align: center;"><input id="checkAll"
								type="checkbox" /></th>
							<th scope="col" style="text-align: center;">账户</th>
							<th scope="col" style="text-align: center;">姓名</th>
							<th scope="col" style="text-align: center;">性别</th>
							<th scope="col" style="text-align: center;">部门</th>
							<th scope="col" style="text-align: center;">职位</th>
							<th scope="col" style="text-align: center;">手机号码</th>
							<th scope="col" style="text-align: center;">邮箱</th>
							 
							<th scope="col" style="text-align: center;">审核人</th>
					...
					<c:forEach items="${requestScope.users}" var="user"
						...
						<tr id="dataTr_${stat.index}" align="center">
							<td  scope="row"><input type="checkbox" name="box" id="box_${stat.index}"
								value="${user.userId}" /></td>
							<td  scope="row">${user.userId}</td>
							<td  scope="row">${user.name}</td>
							<td  scope="row">${user.sex == 1 ? '男' : '女' }</td>
							<td  scope="row">${ user.dept.name}</td>
							<td  scope="row">${ user.job.name}</td>
